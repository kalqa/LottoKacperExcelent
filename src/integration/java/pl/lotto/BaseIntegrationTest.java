...
public class BaseIntegrationTest {
    ...
    @Autowired
    public AdjustableClockIntegration clock;
...
//        registry.add("number-generator.http.client.config.uri", () -> "http://www.randomnumberapi.com");
        registry.add("lotto.number-generator.http.client.config.port", () -> wireMockServer.getPort());
//        registry.add("number-generator.http.client.config.port", () -> 80);
    }
}
