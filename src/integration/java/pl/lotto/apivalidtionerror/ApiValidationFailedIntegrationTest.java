package pl.lotto.apivalidtionerror;
...
public class ApiValidationFailedIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    public void should_return_400_bad_request_and_validation_message_when_empty_in_input_numbers_request() throws Exception {
        // given & when
    ...
    @Test
    public void should_return_400_bad_request_and_validation_message_when_null_in_input_numbers_request() throws Exception {
        // given & when
        ResultActions perform = mockMvc.perform(post("/inputNumbers")
                .content("""
                        {}
